            ...
            <div className="contact-content section-content" >
                ...
                <div className="details-container">
                        <div className="left-contact">
                            ...
                            <p>
                                {/* <i className="fa fa-phone fa-lg" aria-hidden="true"></i> &nbsp;: 91 (0) 044-32220757<br /> */}
                        ...
                        <div className="right-contact">
                            ...
                            <div className="cDetails">
                                    <h3>K. THEN TAMIL SELVI - Director</h3>
                                    <p><i className="fa fa-envelope" aria-hidden="true"></i> &nbsp;  thentamilselvi@ksscmengg.com <br/>
                                    <i className="fa fa-mobile fa-2x" aria-hidden="true"></i> &nbsp;  +91-9962231757</p>
                            </div>
